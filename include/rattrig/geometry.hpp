...
namespace rattrig {
    ...
    template <typename T> struct Point2D {
        ...
        constexpr Point2D() noexcept : x(T(0)), y(T(0)) {}
    ...
    template <typename T> struct Point3D {
        ...
        constexpr Point3D() noexcept : x(T(0)), y(T(0)), z(T(0)) {}
    ...
    template <typename T> struct Vector3D {
        ...
        constexpr Vector3D() noexcept : x(T(0)), y(T(0)), z(T(0)) {}
    ...
    template <typename T> struct Line2D {
        ...
        constexpr Line2D() noexcept : a(T(0)), b(T(0)), c(T(0)) {}
    ...
    template <typename T> struct Triangle2D {
        ...
        constexpr bool is_degenerate() const noexcept { return T(0) == twist(); }
    };
